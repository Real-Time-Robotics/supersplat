    ...
    constructor(events: Events, tooltips: Tooltips, args = { }) {
        ...
        const populateDataSelector = (splat: Splat) => {
            ...
            const localizations: any = {
                ...
                rot_0: `${i18n.t('panel.splat-data.quaternion')} W`,
                rot_1: `${i18n.t('panel.splat-data.quaternion')} X`,
                rot_2: `${i18n.t('panel.splat-data.quaternion')} Y`,
                rot_3: `${i18n.t('panel.splat-data.quaternion')} Z`,
